...
export default {
  ...
  config: {
    showError: {
      title: 'Show errors',
      description:
        'Capture stderr and displays a notification for each command executed',
      type: 'boolean',
      default: true,
    },
    showOutput: {
      title: 'Show outputs',
      description:
        'Capture stdout and displays a notification for each command executed',
      type: 'boolean',
      default: false,
    },
    timeout: {
    ...
    preferLocal: {
      ...
      description:
        'Prefer locally installed binaries when looking for a binary to execute. <br> If you `npm install prettier`, you can then call `prettier` directly',
      type: 'boolean',
      default: true,
    },
    appendFile: {
      title: 'Append file saved to each command',
      description:
        'If you use `standard --fix` and save the file `/dir/savedfile.js`, it will call `standard --fix /dir/savedfile.js`',
      type: 'boolean',
      default: true,
    },
    useCache: {
